...
namespace SuppliesReport.Utility
{
    ...
    public static class RuDateAndMoneyConverter
    {
        ...
        /// <summary>
        /// Десять тысяч рублей шестьдесят семь копеек
        /// </summary>
        /// <param name="_amount"></param>
        /// <param name="_firstCapital"></param>
        /// <returns></returns>
        public static string CurrencyToTxtWithCopecks(double _amount, bool _firstCapital)
        {
            //Десять тысяч рублей шестьдесят семь копеек
            ...
            s += NumeralsToTxt(copecksAmount, TextCase.Nominative, true, false) + " ";
        ...
        /// <param name="_firstCapital"></param>
        /// <returns></returns>
        public static string CurrencyToTxtShorter(double _amount)
        {
            //10 000 рублей 67 копеек        
            long rublesAmount = (long)Math.Floor(_amount);
            long copecksAmount = ((long)Math.Round(_amount * 100)) % 100;
